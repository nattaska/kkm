                                        ...
                                        <div class="custom-tab" id="order-tab">
                                            ...
                                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                ...
                                                foreach ($this->stkItems as $stkItem) {
                                                    ...
                                                    echo '<div class="col-md-2 input-group">
                                                            <input type="number" step="1" class="form-control" id="out'.$stkItem['code'].'" name="items['.$stkItem['code'].'][out]" >                                                          
                                                            &nbsp;+&nbsp; <input type="number" step="1" class="form-control" id="room'.$stkItem['code'].'" name="items['.$stkItem['code'].'][room]" >                                                               
                                                          </div>
                                                          <div class="col-md-2">
