...
try {
    ...
    $db->query("SET @p_edate='2022-10-15';");
    ...
    $sql = "SELECT e.usrcd empcd,@p_edate paydate, ROUND(p.paysal/p.paymethd,0) sal, p.psso sso 
        ...
        UNION	
        SELECT usrcd empcd, @p_edate paydate, paysal sal, null sso, null otpay, null latepay
        ...
        UNION
        SELECT timempcd empcd, @p_edate paydate, COUNT(1)*paysal sal, null sso, SUM(IFNULL(timspec,0))*payothour otpay, null latepay 
            , null advance, null absense, null tax, null total, null ottim, null latetim, null absday, null otsec
            , null latesec, null otmulti, null latemulti
        FROM timesheet, payment
        ...
        <table id="customers">
            <tr>
                ...
                <th style='text-align:center'>Paydate</th>
...
<?php 
        ...
        echo "<tr>
                ...
                <td style='text-align:center'>".$row["paydate"]."</td>
